...
<p>Content
Content
<nav class="table-of-contents"><ul><li><a href="#first-0" title="First">First</a></li><li><a href="#second-1" title="Second">Second</a></li><ul><li><a href="#third-2" title="Third">Third</a></li><li><a href="#third-again-3" title="Third Again">Third Again</a></li><ul><li><a href="#fouth-4" title="Fouth">Fouth</a></li></ul><li><a href="#second-again-6" title="Second Again">Second Again</a></li><ul><li><a href="#third-last-7" title="Third Last">Third Last</a></li></ul></ul></ul></nav></p>`;
  t.is(MarkdownItRenderer.render(markdown, MarkdownItRenderer.defaultConfig()), output);
});
